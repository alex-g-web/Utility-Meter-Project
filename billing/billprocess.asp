...
elseif trim(action)="EditBill" then
	cmd.ActiveConnection = cnn1
	cmd.CommandType = adCmdStoredProc
	cmd.CommandText = "sp_editbill"
	Set prm = cmd.CreateParameter("lid", adInteger, adParamInput)
	cmd.Parameters.Append prm
	Set prm = cmd.CreateParameter("by", adInteger, adParamInput)
	cmd.Parameters.Append prm
	Set prm = cmd.CreateParameter("bp", adInteger, adParamInput)
	cmd.Parameters.Append prm
	Set prm = cmd.CreateParameter("note", adInteger, adParamInput, 1000)
	cmd.Parameters.Append prm
	Set prm = cmd.CreateParameter("bldg", adVarChar, adParamInput, 20)
	cmd.Parameters.Append prm
	Set prm = cmd.CreateParameter("utility", adInteger, adParamInput)
	...
	'cmd.parameters("delete") = 1
	'cmd.parameters("user") = getXmlUserName()
	cmd.parameters("note") = note 'N.Ambo added note filed 9/29/2008
	'response.write "exec sp_editbill '"&cmd.parameters("bldg")&"',"&cmd.parameters("lid")&","&cmd.parameters("by")&","&cmd.parameters("bp")&","&cmd.parameters("utility")&","&cmd.parameters("delete")
	'response.end
	cmd.execute	
end if
