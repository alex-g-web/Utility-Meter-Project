...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <form name="form1" action="dailyexport.asp">
    <tr bgcolor="#eeeeee"> 
...
<%	
	...
	If bperiod <> "" then
		...
		sSql = "EXEC [dbo].[DailyExportSimple]" 
		...
		' Create new csv file 
		csvPath = "d:\ftp\lefrakdata\export files\"
		'csvFile = building & "_" & utility & "_" & byear & right("0" & bperiod,2) & ".txt"
		csvFile = "CPL_BilledTenants_" & ctime & ".txt"
		...
		'else
			csvColumns = "tenantname, tenantnumber, bldgname, bldgnum"
		...
		Do Until rst1.eof
			...
			UTFStream.WriteText chr(34) & rst1("tenantname") & chr(34) & ","
			UTFStream.WriteText chr(34) & rst1("tenantnumber") & chr(34) & ","
			UTFStream.WriteText chr(34) & rst1("bldgname") & chr(34) & ","
			'UTFStream.WriteText chr(34) & rst1("periodstartdate") & chr(34) & ","
			UTFStream.WriteText chr(34) & rst1("bldgnum") & chr(34)
			UTFStream.WriteText crlf
