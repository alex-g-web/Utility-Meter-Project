			...
			<%
				while not rst.eof
					...
					<tr bgcolor="#cccccc" valign="top" onMouseOver="this.style.backgroundColor = 'lightgreen'" style="cursor:hand" 
						onMouseOut="this.style.backgroundColor = '#cccccc'" onClick="openwin('/genergy2/notes/notemanage.asp?mode=view&nid=<%=rst("id")%>&notefortype=<%=notefortype%>&notefor=<%=notefor%>')" > 
