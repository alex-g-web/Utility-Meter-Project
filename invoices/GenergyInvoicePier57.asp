...
dim leaseid, ypid, building, pid, byear, bperiod, utilityid, detailed, meterbreakdown, calcintpeak, SJPproperties, ShowUsageDetails, ShowDemandDetails,onlinereview,totdeliverychrgs, maxmeters, textheader, masterTotal,demo, reject, energydetail, paperless, asql
...
if logo = "" then logo = "cpl_logo.png"
...
%>	 
	...
	<tr>
		...
		<td colspan="3">&nbsp;<br><center><br>
			...
			To view online bill, login to <b>cplgroupusa.com/login-system/</b> with access code </br><b><%=tenantnum%>.<%=building%></b>
		</center></td>
		<% end if %>
		</tr>
	</table>
  ...
  <% 
	...
	if textheader<>"advRealty.asp" and tenantnum <> "" then %>
		<td colspan="3">&nbsp;<br><center><%=txtcontanct2%><br>&nbsp;<br><center><%=txtcontanct%><br>
					To view online bill, login to cplgroupusa.com/login-system/ with access code</br><b><%=tenantnum%>.<%=building%></b>
		</center></td>
	<%end if%></tr>
	</table>
<%end sub
