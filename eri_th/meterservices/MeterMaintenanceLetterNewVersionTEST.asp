...
' Header Columns	
	...
	oDoc.SaveAs("\\serv-db\web_folders\finance\"  & ctime & "MeterLetter.docx")
	...
	strFilename = "\\serv-db\web_folders\finance\"  & ctime & "MeterLetter.docx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>MeterLetter.docx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>MeterLetter.docx</b></a> 
	</p>
	<%
	Else
	%>
