...
<html>
<head>
<title>Meter Setup Charges Building</title>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <form name="form1" action="MeterSetupChargesBuilding.asp">
    <tr bgcolor="#eeeeee"> 
...
<%	
    ...
    objWorkSheet.Cells(iRow,3) = "MeterNumber"
    objWorkSheet.Cells(iRow,4) = "MeterSetupChargeTimestamp"
    objWorkSheet.Cells(iRow,5) = "DatesSearched"
    		
	sSql = "Exec sp_select_metersetup_charges_building " & "'" & building & "'" & "," & Billyear & "," & BillPeriod 
	...
	Do Until rst1.eof
        ...
        objWorkSheet.Cells(iRow,3) = rst1("MeterNumber")
        objWorkSheet.Cells(iRow,4) = rst1("MeterSetupChargeTimestamp")
	...
	dim ctime 
    ctime = hour(now) & minute(now) & second(now) & Billyear  & Billperiod  & building
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "MeterSetupChargesBuilding.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\" & ctime & "MeterSetupChargesBuilding.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>MeterSetupChargesBuilding.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>MeterSetupChargesBuilding.xlsx</b></a> 
	</p>
	<%
	Else
	%>
...
<Script type=text/javascript>
    function loadperiod() {
        ...
        var newhref = "MeterSetupChargesBuilding.asp?" + "&building=" + frm.building.value + "&billyear=" + frm.billyear.value
        document.location.href = newhref;
    }

    function loadutility() {
        var frm = document.forms['form1'];
        var newhref = "MeterSetupChargesBuilding.asp?building=" + frm.building.value + "&utilityid=" + frm.utilityid.value;
        document.location.href = newhref;
    }
</Script>
<%
