      ...
      <td colspan="2" style="border-top:1px solid #ffffff;border-bottom:1px solid #cccccc;"> 
         <table border=0 cellpadding="3" cellspacing="0">
          <tr> 
				...
				<td> <select name="utilityid" onChange="document.location='BuildingTaxPrepSheet.asp?bldgnum=<%=building%>&utilityid='+this.value">
            ...
            <td> <select name="billyear" onChange="document.location='BuildingTaxPrepSheet.asp?bldgnum=<%=building%>&utilityid=<%=utilityid%>&billyear='+this.value">
...
<%	
	...
	objWorkSheet.Cells.Font.Size = 16
    objWorkSheet.Columns(1).ColumnWidth = 32
    objWorkSheet.Columns(2).ColumnWidth = 32
    objWorkSheet.Columns(3).ColumnWidth = 32
    objWorkSheet.Columns(4).ColumnWidth = 32
    objWorkSheet.Columns(5).ColumnWidth = 32
    objWorkSheet.Columns(6).ColumnWidth = 32
...
' Header Columns	
   ...
   ' objWorkSheet.PageSetup.Zoom = False
    ...
    objWorkSheet.Cells(iRow,5) = "Current Sales Taxes"
    ...
    objWorkSheet.Range("A" & irow & ":C" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("A" & irow).HorizontalAlignment = -4108
    objWorkSheet.Range("E" & irow & ":F" & irow).Merge
    objWorkSheet.Range("E" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("E" & irow).HorizontalAlignment = -4108
	...
	objWorkSheet.Cells(iRow,5) = "NYS"
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5).Font.ColorIndex = 2
    objWorkSheet.Cells(iRow,6) = rst1("currentstatesalestax")
    objWorkSheet.Cells(iRow,6).Font.Bold = true

    objWorkSheet.Cells(iRow,1).Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    objWorkSheet.Cells(iRow,6).Borders.Weight = 4
    objWorkSheet.Range("B" & irow & ":C" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,2).Font.Bold = true
	objWorkSheet.Cells(iRow,5) = "NYC"
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5).Font.ColorIndex = 2
    objWorkSheet.Cells(iRow,6) = rst1("currentcitysalestax")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Cells(iRow,1).Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    objWorkSheet.Cells(iRow,6).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,2).Font.Bold = true
    objWorkSheet.Cells(iRow,5) = "*MCDT"
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5).Font.ColorIndex = 2
    objWorkSheet.Cells(iRow,6) = rst1("currentmetrotax")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Cells(iRow,1).Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    objWorkSheet.Cells(iRow,6).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,5).Font.ColorIndex = 2
    objWorkSheet.Cells(iRow,5).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,6) = rst1("totalsalestaxrate")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Cells(iRow,1).Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    objWorkSheet.Cells(iRow,6).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,1).Font.Bold = true
    objWorkSheet.Cells(iRow,5) = "*Metro Commuter District Transportation Tax"  
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    ...
    objWorkSheet.Cells(iRow,5).Interior.ColorIndex = 46
    objWorkSheet.Range("B" & irow & ":E" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("B" & irow).HorizontalAlignment = -4108
    ...
    iRow = iRow + 5
    objWorkSheet.Cells(iRow,1).Font.Bold = True
	objWorkSheet.Cells(iRow,2) = "Tenant Submeter Billing"
    objWorkSheet.Cells(iRow,2).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Font.ColorIndex = 2
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    ...
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    'objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("totalsubmeterbilling")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("totaltaxablenet")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("totaltenantbilling")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("totalsalestax")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3) = "ConEd"
    ...
    objWorkSheet.Cells(iRow,5) = rst1("combinedbillnet")
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,4).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,5) = rst1("combinedsalestaxcalc")
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,4).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,5) = rst1("combinedsalestaxpaid")
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,4).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    ...
    objWorkSheet.Cells(iRow,5) = rst1("combinedbilltotalcalc")
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,4).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    ...
    objWorkSheet.Cells(iRow,5) = rst1("combinedbilltotalpaid")
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,4).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    ...
    objWorkSheet.Cells(iRow,4) = rst1("unpaidescousetax")
    objWorkSheet.Cells(iRow,5) = rst1("combinedunpaid")
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,4).Font.Bold = true
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    ...
    iRow = iRow + 3
    objWorkSheet.Cells(iRow,1).Font.Bold = True
	objWorkSheet.Cells(iRow,2) = " Electricity Sales & Use"
    objWorkSheet.Cells(iRow,2).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Font.ColorIndex = 2
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("electricitypurchased")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("electricityresold")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("ratio")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("calcelectricityresoldPER")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("calcelectricityresoldNYC")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("calcelectricityresoldNYS")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    iRow = iRow + 1
    objWorkSheet.Cells(iRow,1).Font.Bold = False
	objWorkSheet.Cells(iRow,2) = "Calc. Credit For Use Tax Paid on Electricity that Was Resold"
    objWorkSheet.Cells(iRow,2).Font.Bold = true
    objWorkSheet.Cells(iRow,2).Font.ColorIndex = 2
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,3).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,4).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,5) = rst1("calccredit")
    objWorkSheet.Cells(iRow,5).Font.Bold = true
    objWorkSheet.Range("B" & irow & ":D" & irow).Merge
    objWorkSheet.Range("B" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Cells(iRow,5).Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,5).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,6).Interior.ColorIndex = 46
    objWorkSheet.Range("A" & irow & ":F" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,6) = rst1("totalgrosssubmeterbillecltax")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("C" & irow & ":E" & irow).Merge
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,6) = rst1("totalgrosssubmeterbillecltaxexempt")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("C" & irow & ":E" & irow).Merge
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,6) = rst1("calcpurchases")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("C" & irow & ":E" & irow).Merge
    ...
    objWorkSheet.Cells(iRow,6) = rst1("foura")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Cells(iRow,6).Font.ColorIndex = 46
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("C" & irow & ":E" & irow).Merge
    objWorkSheet.Range("C" & irow).MergeArea.Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,3).Font.ColorIndex = 46
    objWorkSheet.Cells(iRow,6) = rst1("fourb")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Cells(iRow,6).Font.ColorIndex = 46
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,3).Font.ColorIndex = 46	
    objWorkSheet.Cells(iRow,6) = rst1("fourc")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Cells(iRow,6).Font.ColorIndex = 46
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,6) = rst1("totalsalestaxbilled")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("C" & irow & ":E" & irow).Merge
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,6) = rst1("line4minusline5")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("C" & irow & ":E" & irow).Merge
    ...
    objWorkSheet.Cells(iRow,3).Font.Bold = true
    objWorkSheet.Cells(iRow,6) = rst1("line6minusline9")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
    objWorkSheet.Range("A" & irow & ":B" & irow).Merge
    objWorkSheet.Range("A" & irow).MergeArea.Borders.Weight = 4
    objWorkSheet.Range("C" & irow & ":E" & irow).Merge
    ...
    objWorkSheet.Cells(iRow,1).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,2).Interior.ColorIndex = 46
    objWorkSheet.Cells(iRow,6) = rst1("line10plusline11")
    objWorkSheet.Cells(iRow,6).Font.Bold = true
