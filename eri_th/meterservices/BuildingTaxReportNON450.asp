...
' Header Columns	
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "BuildingTaxReport.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\"  & ctime & "BuildingTaxReport.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>BuildingTaxReport.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>BuildingTaxReport.xlsx</b></a> 
	</p>
	<%
	Else
	%>
