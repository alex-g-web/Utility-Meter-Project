...
' Header Columns	
	If not rst1.eof then
        ...
        objWorkSheet.Cells(i,17) = "Utility Bill Expense(100%)"
        ...
        objWorkSheet.Cells(i,17).Interior.ColorIndex = 36 
	...
	sSql = "Exec usp_UtilityBillReportCalc_spec " & "'" & building & "'" & ", " & UtilityId  & "," & Billyear & "," & BillPeriod 
	rst1.CursorLocation = 3
	rst1.open sSql , cnn1, 3 
	Do Until rst1.eof
        ...
        objWorkSheet.Cells(iRow,17) = rst1("UtilityBillExpense100pct")
        ...
        objWorkSheet.Cells(iRow,17).Interior.ColorIndex = 36  
	...
	sSql = "Exec usp_UtilityBillReportTotal_spec " & "'" & building & "'" & ", " & UtilityId  & "," & Billyear & "," & BillPeriod 
	rst1.CursorLocation = 3
	rst1.open sSql , cnn1, 3 
	Do Until rst1.eof
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "UtilityBillReport.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\"  & ctime & "UtilityBillReport.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>UtilityBillReport.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>UtilityBillReport.xlsx</b></a> 
	</p>
	<%
	Else
	%>
