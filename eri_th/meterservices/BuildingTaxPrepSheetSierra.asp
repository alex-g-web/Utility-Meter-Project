...
' Header Columns	
    ...
    objWorkSheet.Cells(iRow,2) = taxid
    objWorkSheet.Cells(iRow,1).Font.Bold = true
    ...
    objWorkSheet.Cells(iRow,1) = "Unpaid Use Tax"
     objWorkSheet.Cells(iRow,1).Borders(7).Weight = 4
	 objWorkSheet.Cells(iRow,7) = rst1("salesserviceunpaid")
    objWorkSheet.Cells(iRow,7).HorizontalAlignment = -4108
     objWorkSheet.Cells(iRow,8) = rst1("unpaidusetax")
    objWorkSheet.Cells(iRow,8).HorizontalAlignment = -4108
     objWorkSheet.Cells(iRow,7).Borders(7).Weight = 4
    objWorkSheet.Cells(iRow,7).Borders(10).Weight = 4
    objWorkSheet.Cells(iRow,8).Borders(10).Weight = 4
    ...
    iRow = iRow + 1
    objWorkSheet.Cells(iRow,1) = "Credits against Purchases Subject to Tax"
    'objWorkSheet.Cells(iRow,4) = 8.875
     objWorkSheet.Cells(iRow,4).NumberFormat = "@"
     objWorkSheet.Cells(iRow,4) ="8.875%"
     objWorkSheet.Cells(iRow,1).Borders(7).Weight = 4
    objWorkSheet.Cells(iRow,7) = rst1("creditsagainstpurchases")
    objWorkSheet.Cells(iRow,7).HorizontalAlignment = -4108
    objWorkSheet.Cells(iRow,8) = rst1("creditsagainstpurchasestax")
    objWorkSheet.Cells(iRow,8).HorizontalAlignment = -4108
     objWorkSheet.Cells(iRow,7).Borders(7).Weight = 4
    objWorkSheet.Cells(iRow,7).Borders(10).Weight = 4
    objWorkSheet.Cells(iRow,8).Borders(10).Weight = 4
 ...
 '   objWorkSheet.Cells(iRow,8).Borders(10).Weight = 4
	 ...
	 iRow = iRow + 1
   objWorkSheet.Cells(iRow,1) = "Rounding Correction"
   
     objWorkSheet.Cells(iRow,1).Borders(7).Weight = 4
    objWorkSheet.Cells(iRow,7).HorizontalAlignment = -4108
    objWorkSheet.Cells(iRow,8) = rst1("roundingerror")
    objWorkSheet.Cells(iRow,8).HorizontalAlignment = -4108
    objWorkSheet.Cells(iRow,7).Borders(7).Weight = 4
    objWorkSheet.Cells(iRow,7).Borders(10).Weight = 4
    objWorkSheet.Cells(iRow,8).Borders(10).Weight = 4
    ...
    objWorkSheet.Cells(iRow,8).Borders(10).Weight = 4
    iRow = iRow + 1
    objWorkSheet.Cells(iRow,1) = "* Unpaid Use Tax: as a result of Applicable Tax Rate > Charged Rate by Utility Bill"
    iRow = iRow + 1
    objWorkSheet.Cells(iRow,1) = "** Credits against taxable sales and services: PAID Sales Tax for Purchases thru. Utility Bills"
    iRow = iRow + 1
    objWorkSheet.Cells(iRow,1) = "*** Purchases subject to tax: Applicable Sales Tax for NON-resold Purchases"
