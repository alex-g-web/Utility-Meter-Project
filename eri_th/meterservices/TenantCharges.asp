...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <form name="form1" action="TenantCharges.asp">
    <tr bgcolor="#eeeeee"> 
...
<%	
	...
	sSql = "Exec sp_select_tenant_charges " & Billyear & "," & BillPeriod 
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "TenantCharges.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\" & ctime & "TenantCharges.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>TenantCharges.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>TenantCharges.xlsx</b></a> 
	</p>
	<%
	Else
	%>
...
<Script type=text/javascript>
    function loadperiod() {
        ...
        var newhref = "TenantCharges.asp?" + "&building=" + frm.building.value + "&billyear=" + frm.billyear.value
        document.location.href = newhref;
    }

    function loadutility() {
        var frm = document.forms['form1'];
        var newhref = "TenantCharges.asp?building=" + frm.building.value + "&utilityid=" + frm.utilityid.value;
        document.location.href = newhref;
    }
</Script>
<%
