...
<%	
	...
	objWorkSheet.Cells(iRow,19) = "Portfolio"
	objWorkSheet.Cells(iRow,20) = "BuildingNum"
		
	sSql = "Exec sp_select_portbldgmeter_counts_active " & "'" & building & "'"
	...
	Do Until rst1.eof
		...
		objWorkSheet.Cells(iRow,19) = rst1("portfolioname")
		objWorkSheet.Cells(iRow,20) = rst1("buildingnum")		
