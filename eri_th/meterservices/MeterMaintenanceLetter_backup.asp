...
' Header Columns	
	...
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=building%><%=billyear%><%=billperiod%><%=UtilityId%>MeterLetter.xls" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=building%>MeterLetter.xls</b></a> 
	</p>
	<%
	Else
	%>
