...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <form name="form1" action="MeterCountCharge.asp">
    <tr bgcolor="#eeeeee"> 
...
<%	
	...
	sSql = "Exec sp_select_meter_charged_count " & Billyear & "," & BillPeriod 
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "MeterChargeCount.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\"  & ctime & "MeterChargeCount.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>MeterChargeCount.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>MeterChargeCount.xlsx</b></a> 
	</p>
	<%
	Else
	%>
