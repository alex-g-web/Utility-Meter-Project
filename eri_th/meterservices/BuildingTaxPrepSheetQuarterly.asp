...
' Header Columns	
    ...
    'objWorkSheet.Shapes.AddPicture "https://appserver1.genergy.com/genergy2/eri_th/meterservices/invoice_logo_1.jpeg", False, True, 0, 0, 100, 100
    iRow = iRow + 5
   ...
   objWorkSheet.Cells(iRow,7) = rst1("toaltaxesdue5")
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "TaxPrepSheetQtr.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\"  & ctime & "TaxPrepSheetQtr.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>TaxPrepSheetQtr.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>TaxPrepSheetQtr.xlsx</b></a> 
	</p>
	<%
	Else
	%>
