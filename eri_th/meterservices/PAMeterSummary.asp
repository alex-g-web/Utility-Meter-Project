...
' Header Columns	
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\PA\" & building&"\" & building  & "MeterSummary" & BillYear & strBillPeriod & ".xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\PA\" & building & "\" & building & "MeterSummary" & BillYear & strBillPeriod & ".xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/PA/<%=building%>\<%=building%>MeterSummary<%=Billyear%><%=strBillPeriod%>.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=building%>MeterSummary<%=Billyear%><%=strBillPeriod%>.xlsx</b></a> 
	</p>
	<%
	Else
	%>
