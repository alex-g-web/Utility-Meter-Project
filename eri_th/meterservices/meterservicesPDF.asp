...
function tenantdetails(){
	var frm = document.forms['lmp'];
	var temp="leasehistoryPDF.asp?demo=<%=demo%>&leaseid=" + frm.leaseid.value + "&b=" + frm.bldg.value;
	document.getElementById('panel1').src=temp;
}
function loadinvoice(ypid,lid){
			var temp= "invoice.asp?y=" + ypid + "&l=" + lid 
			document.getElementById('panel2').src=temp;
	}
  ...
  <form method="post" action="" name="lmp">
    ...
    <table height="100%" width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
          ...
          <div align="left"> 
            <div align="center"> 
              ...
              <div align="left"><font face="Arial, Helvetica, sans-serif" size="3">
                ...
                <select name="leaseid" onChange="tenantdetails()">
      ...
      <%
        ...
        rst1.close
			%>
                </select><input type="button" name="Load" value="Load History" onClick="tenantdetails()"
                </font></div>
            </div>
          </div>
        </td>
      ...
      <tr >
        <td >
			<p align="left"><IFRAME id="panel1" name="panel" src="/mymain.htm" width="100%" height="300" scrolling="auto" marginwidth="8" marginheight="16"></IFRAME></p>
		</td>
      </tr>
      <tr > 
        <td >
			<p align="left"><IFRAME id="panel2" name="panel_2" src="/null.htm" width="100%" height="150" scrolling="auto" marginwidth="8" marginheight="16"></IFRAME></p>
        </td>
      </tr>
    </table>
  </form>
