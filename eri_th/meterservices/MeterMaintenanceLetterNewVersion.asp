...
' Header Columns	
	If not rst1.eof then
        ...
        objWorkSheet.Cells(1,1).Font.Bold = True
        objWorkSheet.Cells(1,1).Font.Size = 48    
        objWorkSheet.Cells(1,1) = "GENERGY"
		...
		'objWorkSheet.easy_getSheetAt(0).easy_addImage_5 "D:\\websites\\utilitymanager\\images\\genergy.jpg", "A1"
		
		dim i,j,picPath, Left,Top, Width, Height
		'i="a"
		'j=1
		picPath  = "D:\\websites\\utilitymanager\\images\\genergyFULL.png"
		'Left   = objWorkSheet.Range(objWorkSheet.Cells("A","1").Address).Left
		'Top    = objWorkSheet.Range(objWorkSheet.Cells("A","1").Address).Top
		'Width  = objWorkSheet.Range(objWorkSheet.Cells("A","1").Address).Width
		'Height = objWorkSheet.Range(objWorkSheet.Cells("A","1").Address).Height
		'WorkSheet.Shapes.AddPicture picPath, False, True, Left, Top, Width, Height	
		'*** Insert Picture (1) ***'  
		'objExcelReport.Range("A1").Select()  
		'objExcelReport.ActiveSheet.Pictures.Insert("images\genergyprint.jpg")
		
		'objExcelReport.Range("A1").Select()  
		'objWorkSheet.Shapes.AddPicture picPath, False, True, 0, 0, 451,63
	...
	objWorkSheet.Cells(iRow,1).Font.Bold = False
	objWorkSheet.Cells(iRow,1) = "Please feel free to email us at help@genergy.com with any questions, comments or concerns."
	...
	objWorkSheet.Cells(iRow,1).Font.Bold = False
	objWorkSheet.Cells(iRow,1) = "GEnergy"
