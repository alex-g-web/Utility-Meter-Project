...
<%	
	...
	If billperiod <> "" then
     ...
     End if
		...
		<br>
		<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=building%>_TenantSubTotals_<%=MonthName(Billperiod)%><%=Billyear%>.csv" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=building%>_TenantSubTotals_<%=MonthName(Billperiod)%><%=Billyear%>.csv</b></a>
		<br>
		<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=building%>_TenantSubTotals_<%=MonthName(Billperiod)%><%=Billyear%>.csv" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=building%>_TenantTax_<%=MonthName(Billperiod)%><%=Billyear%>.csv</b></a> 
		</p>
		<%
		Else
		%>
