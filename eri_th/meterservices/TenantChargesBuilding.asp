...
<html>
<head>
<title>Tenant Charges Building</title>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <form name="form1" action="TenantChargesBuilding.asp">
    <tr bgcolor="#eeeeee"> 
...
<%	
    ...
    objWorkSheet.Cells(iRow,2) = "TenantName"
    objWorkSheet.Cells(iRow,3) = "LeaseReviewCharge"
    objWorkSheet.Cells(iRow,4) = "LeaseReviewTimeStamp"
    objWorkSheet.Cells(iRow,5) = "TenantSetupCharge"
	objWorkSheet.Cells(iRow,6) = "TenantSetupTimeStamp"
    objWorkSheet.Cells(iRow,7) = "DatesSearched"
    

    		
	sSql = "Exec sp_select_tenant_charges_building " & "'" & building & "'" & ", " & Billyear & "," & BillPeriod 
	...
	Do Until rst1.eof
	    ...
	    objWorkSheet.Cells(iRow,2) = rst1("billingname")
        objWorkSheet.Cells(iRow,3) = rst1("LeaseReviewYes")
        objWorkSheet.Cells(iRow,4) = rst1("LeaseReviewTimeStamp")
        objWorkSheet.Cells(iRow,5) = rst1("TenantSetupYes")
	    objWorkSheet.Cells(iRow,6) = rst1("TenantSetupTimeStamp")
        objWorkSheet.Cells(iRow,7) = rst1("datessearched")
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "TenantChargesBuilding.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\" & ctime & "TenantChargesBuilding.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>TenantChargesBuilding.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>TenantChargesBuilding.xlsx</b></a> 
	</p>
	<%
	Else
	%>
...
{	var frm = document.forms['form1'];
    var newhref = "TenantChargesBuilding.asp?" + "&building=" + frm.building.value + "&billyear=" + frm.billyear.value
	document.location.href=newhref;
}

function loadutility()
{	var frm = document.forms['form1'];
    var newhref = "TenantChargesBuilding.asp?building=" + frm.building.value + "&utilityid=" + frm.utilityid.value;
	document.location.href=newhref;
}
</Script>
<%
