...
<html>
<head>
<title>Meter Charge Count</title>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <form name="form1" action="MeterCountChargeBuilding.asp">
    <tr bgcolor="#eeeeee"> 
...
<%	
	...
	objWorkSheet.Cells(iRow,4) = "BillYear"
    objWorkSheet.Cells(iRow,5) = "BillPeriod"
    objWorkSheet.Cells(iRow,6) = "PostDate"
    objWorkSheet.Cells(iRow,7) = "DatesSearched"
    

    		
	sSql = "Exec sp_select_meter_charged_building " & "'" & building & "'" & ", " & Billyear & "," & BillPeriod 
	...
	Do Until rst1.eof
        ...
        objWorkSheet.Cells(iRow,6) = rst1("postdate")
	...
	objWorkBook.SaveCopyAs("\\serv-db\web_folders\finance\"  & ctime & "MeterChargeBuilding.xlsx")
	...
	strFilename = "\\serv-db\web_folders\finance\"  & ctime & "MeterChargeBuilding.xlsx"
	If objFSO.FileExists(strFileName) Then 
	%>
	<p> Following report has been generated :
	<a style="font-family:arial;font-size:12;text-decoration:none;color:black;" href="https://appserver1.genergy.com/eri_TH/finance/<%=ctime%>MeterChargeBuilding.xlsx" target="_blank" onMouseOver="this.style.color= 'lightblue'"; onMouseOut="this.style.color = 'black'"><b><%=ctime%>MeterChargeBuilding.xlsx</b></a> 
	</p>
	<%
	Else
	%>
...
{	var frm = document.forms['form1'];
    var newhref = "MeterCountCharge.asp?" + "&building=" + frm.building.value + "&billyear=" + frm.billyear.value
	document.location.href=newhref;
}

function loadutility()
{	var frm = document.forms['form1'];
    var newhref = "MeterCountCharge.asp?building=" + frm.building.value + "&utilityid=" + frm.utilityid.value;
	document.location.href=newhref;
}
</Script>
<%
