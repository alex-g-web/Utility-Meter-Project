...
<table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
   <form name="form1" action="BuildingTaxPrepSheetSierra-RITA.asp">
    <tr bgcolor="#eeeeee"> 
...
' Header Columns	
    ...
    sSql = "Exec usp_TaxPrep_rita_section2 " & "'" & building & "'" & ", " & UtilityId  & "," & Billyear & "," & Quarter & "," & prevjan & "," & jan & "," & prevfeb & "," & feb & "," & prevmar & "," & mar & "," & prevapr & "," & apr & "," & prevmay & "," & may & "," & prevjun & "," & jun & "," & prevjul & "," & jul & "," & prevaug & "," & aug & "," & prevsep & "," & sep & "," & prevoct & "," & oct & "," & prevnov & "," & nov & "," & prevdec & "," & dec
	rst1.CursorLocation = 3
	rst1.open sSql , cnn1, 3 
	Do Until rst1.eof
	...
	rst1.close
     iRow = iRow + 1
     sSql = "Exec usp_TaxPrep_rita_section2total " & "'" & building & "'" & ", " & UtilityId  & "," & Billyear & "," & Quarter & "," & prevjan & "," & jan & "," & prevfeb & "," & feb & "," & prevmar & "," & mar & "," & prevapr & "," & apr & "," & prevmay & "," & may & "," & prevjun & "," & jun & "," & prevjul & "," & jul & "," & prevaug & "," & aug & "," & prevsep & "," & sep & "," & prevoct & "," & oct & "," & prevnov & "," & nov & "," & prevdec & "," & dec
	rst1.CursorLocation = 3
	rst1.open sSql , cnn1, 3 
    objWorkSheet.Cells(iRow,3) = "TOTAL"
     objWorkSheet.Cells(iRow,3).Borders(10).Weight = 4
    ...
    sSql = "Exec usp_TaxPrep_rita_section2esco " & "'" & building & "'" & ", " & UtilityId  & "," & Billyear & "," & Quarter & "," & prevjan & "," & jan & "," & prevfeb & "," & feb & "," & prevmar & "," & mar & "," & prevapr & "," & apr & "," & prevmay & "," & may & "," & prevjun & "," & jun & "," & prevjul & "," & jul & "," & prevaug & "," & aug & "," & prevsep & "," & sep & "," & prevoct & "," & oct & "," & prevnov & "," & nov & "," & prevdec & "," & dec
	rst1.CursorLocation = 3
	rst1.open sSql , cnn1, 3 
	Do Until rst1.eof
	...
	rst1.close
     iRow = iRow + 1
     sSql = "Exec usp_TaxPrep_rita_section2totalesco " & "'" & building & "'" & ", " & UtilityId  & "," & Billyear & "," & Quarter & "," & prevjan & "," & jan & "," & prevfeb & "," & feb & "," & prevmar & "," & mar & "," & prevapr & "," & apr & "," & prevmay & "," & may & "," & prevjun & "," & jun & "," & prevjul & "," & jul & "," & prevaug & "," & aug & "," & prevsep & "," & sep & "," & prevoct & "," & oct & "," & prevnov & "," & nov & "," & prevdec & "," & dec
	rst1.CursorLocation = 3
	rst1.open sSql , cnn1, 3 
	objWorkSheet.Cells(iRow,3) = "TOTAL"
     objWorkSheet.Cells(iRow,3).Borders(10).Weight = 4
   ...
   ' objWorkSheet.Cells(iRow,8).Borders(10).Weight = 4
    ...
    objWorkSheet.Cells(iRow,1).HorizontalAlignment = -4108
     ...
     iRow = iRow + 1
     sSql = "Exec usp_TaxPrep_rita_section4 " & "'" & building & "'" & ", " & UtilityId  & "," & Billyear & "," & Quarter & "," & prevjan & "," & jan & "," & prevfeb & "," & feb & "," & prevmar & "," & mar & "," & prevapr & "," & apr & "," & prevmay & "," & may & "," & prevjun & "," & jun & "," & prevjul & "," & jul & "," & prevaug & "," & aug & "," & prevsep & "," & sep & "," & prevoct & "," & oct & "," & prevnov & "," & nov & "," & prevdec & "," & dec
	rst1.CursorLocation = 3
	rst1.open sSql , cnn1, 3 
...
<Script type=text/javascript>
    function loadQuarter() {
        ...
        var newhref = "BuildingTaxPrepSheetSierra-RITA.asp?" + "&building=" + frm.building.value + "&billyear=" + frm.billyear.value + "&pid=" + frm.pid.value;
        document.location.href = newhref;
    }

    function loadutility() {
        var frm = document.forms['form1'];
        var newhref = "BuildingTaxPrepSheetSierra-RITA.asp?building=" + frm.building.value + "&utilityid=" + frm.utilityid.value + "&pid=" + frm.pid.value;
        document.location.href = newhref;
    }
