...
dim MSCDetail, MSCDetailOFF, totalkwcost,grossreceiptsupply,Estimated, NoEsco, kvar, rpd, gtdemand, pridemand, secdemand, gtkw, billingdatestart, billingdateend
bldg = request("bldg")
...
billingdatestart = Request.form("billingdatestart")
billingdateend = Request.form("billingdateend")
...
NoEsco = Request.form("NoEsco")
kvar = Request.form("kvar")
rpd = Request.form("rpd")
gtdemand = Request.form("gtdemand")
pridemand = Request.form("pridemand")
secdemand = Request.form("secdemand")
gtkw = Request.form("gtkw")
