...
dim AdminFee, TenantRate, AddonFee, ModifyRate, Coincident, CoinWithPeak, FullOnPeak, procname, customsrc, calcIntPeak, acctid, use_acctid, billnote, shadow, ticketcount, masterticketid,opentickets, criticalopentickets, totaltickets, UseBldgRate, externalfee, externalfeename, lmepcredit
if trim(lid)<>"" then
	...
	if not rst1.EOF then
		...
		externalfee = rst1("externalfee")
		externalfeename = rst1("externalfeename")
		lmepcredit = rst1("lmepcredit")
	end if
	rst1.close
...
<tr bgcolor="#3399cc">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#eeeeee">
	...
	<tr bgcolor="#eeeeee"> 
      <td align="right"><span class="standard">External Fee Name</span></td>
      <td><input type="text" name="externalfeename" value="<%=externalfeename%>"></td>
	</tr>
    <tr bgcolor="#eeeeee"> 
	  <td align="right"><span class="standard">External Fee Value</span></td>
	  <td><input type="text" name="externalfee" value="<%=externalfee%>"></td>
    </tr>
    <tr bgcolor="#eeeeee"> 
	...
	<tr bgcolor="#eeeeee"> 
	  <td align="right"><span class="standard">LMEP Credit</span></td>
	  <td><input type="text" name="lmepcredit" value="<%=lmepcredit%>"></td>
    </tr>
    <tr bgcolor="#eeeeee"> 
