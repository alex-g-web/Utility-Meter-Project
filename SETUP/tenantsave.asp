...
dim tenantnum, flr, sqft, taxexempt, billingname, leaseexpired, interm, intermcharges, startdate, bldg, action, tid, pid, tName, tStrt, tCity, tState, tZip, tCountry, lmepExempt, onlinebill, ibsexempt, bsexempt, accounttype, lookup, paperless_email
...
dim basebuilding
dim leasereviewno, leasereviewyes,tenantsetupyes,leasereviewtimestamp,tenantsetuptimestamp,residential
...
basebuilding = secureRequest("basebuilding")
tenantsetupyes = secureRequest("tenantsetupyes")
leasereviewyes = secureRequest("leasereviewyes")
residential = secureRequest("residential")

leasereviewtimestamp = FormatDateTime(Now)
tenantsetuptimestamp = FormatDateTime(Now)
...
paperless_email = secureRequest("paperless_email")
...
dim returnpage
returnpage = "tenantedit.asp?pid="&pid&"&bldg="&bldg&"&tid="&tid&"&edit=0"
...
<input type="hidden" name="basebuilding" value="<%=basebuilding%>">
<input type="hidden" name="tenantsetupyes" value="<%=tenantsetupyes%>">
<input type="hidden" name="leasereviewyes" value="<%=leasereviewyes%>">
...
<input type="hidden" name="paperless_email" value="<%=paperless_email%>">
