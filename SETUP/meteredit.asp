...
<!--        <tr bgcolor="#eeeeee"> 
        ...
        <tr bgcolor="#CCCCCC">
            ...
            <td style="border-right:1px solid #eeeeee;">
                <select name="gateComm" onchange="changedCommType(this.value)" >
					...
					<option value="Flat CSV File" <% if trim(gateComm) = "Flat CSV File" then %> selected <% end if %> >Flat CSV File</option>
            </select></td>
  ...
  <tr bgcolor="#eeeeee"> 
    <td colspan="3" bgcolor="#eeeeee" style="border-top:1px solid #ffffff;"> <table border=0 cellpadding="3" cellspacing="0">
        <% if Cint(pid) = 108 then %>
		...
		<% end if%>
          <tr bgcolor="#eeeeee"> 
            <td colspan=2>
				...
				<input type="checkbox" value="1" name="lmp" <%if lmp="True" then Response.Write "CHECKED"%>>&nbsp;<span class="standard">LMP</span>
				&nbsp;&nbsp;&nbsp; 
				<input type="checkbox" value="1" name="hascoincd" <%if hascoincd="True" then Response.Write "CHECKED"%>>&nbsp;<span class="standard">Coincidental Demand</span></td> 
          </tr>
        </table></td>
  </tr>
  <tr bgcolor="#cccccc"> 
