...
<%
	...
	if rbid <>"" then
		...
		strsql = "select top 1 *, case when rateperiod='"& today &"' then 1 else 0 end as exacting from ratebuilder where rateperiod <= '" &today& "' and rbrid is not null order by rateperiod desc, modifiedOn desc"
	end if
	...
	<table border=0 cellpadding=0 cellspacing=0 width=1001 style='border-collapse:collapse;table-layout:fixed;width:753pt'>
		...
		<form name="RateBuilderComponents" method="post" action="saveComponents.asp">
			...
			<tr class=xl97 height=10 style='mso-height-source:userset;height:7.5pt'>
				...
				<td height=21 class=xl97 style='height:15.75pt'></td>
				<td class=xl95>&nbsp;</td>
				<td colspan=5 rowspan=2 class=xl146>Arrears Management Program Recovery Surcharge</td>
				<td rowspan=2 class=xl226 >
					R<input tabindex="999" type="checkbox" name="d_samp_r" value="<%= d_samp_r %>" /></td>
				<td class=xl233>&nbsp;</td>
				<td class=xl227>SC9-I</td>
				<td class=xl227>SC9-II & III</td>
				<td class=xl228>SC12-II</td>
			...
			<tr height=21 style='height:15.75pt'>
				...
				<td class=xl95>&nbsp;</td>
				<td class=xl233>&nbsp;</td>
				<td class=xl231><input class=box name="d_samp_sc9_1" value="<%= d_samp_sc9_1 %>" /></td>
				<td class=xl231><input class=box name="d_samp_sc9_2_3" value="<%= d_samp_sc9_2_3 %>" /></td>
				<td class=xl232><input class=box name="d_samp_sc12_2" value="<%= d_samp_sc12_2  %>" /></td>
				<td class=xl96>&nbsp;</td>
			</tr>
			<tr class=xl97 height=10 style='mso-height-source:userset;height:7.5pt'>
				<td height=10 class=xl97 style='height:7.5pt'></td>
				...
				<td height=21 class=xl97 style='height:15.75pt'></td>
				<td class=xl95>&nbsp;</td>
				<td colspan=5 rowspan=2 class=xl146>Electric Vehicle Make Ready Surcharge</td>
				<td rowspan=2 class=xl226 >
					R<input tabindex="999" type="checkbox" name="d_sevm_r" value="<%= d_sevm_r %>" /></td>
				<td class=xl233>&nbsp;</td>
				<td class=xl227>SC9-I</td>
				<td class=xl227>SC9-II & III</td>
				<td class=xl228>SC12-II</td>
			...
			<tr height=21 style='height:15.75pt'>
				...
				<td class=xl95>&nbsp;</td>
				<td class=xl233>&nbsp;</td>
				<td class=xl231><input class=box name="d_sevm_sc9_1" value="<%= d_sevm_sc9_1 %>" /></td>
				<td class=xl231><input class=box name="d_sevm_sc9_2_3" value="<%= d_sevm_sc9_2_3 %>" /></td>
				<td class=xl232><input class=box name="d_sevm_sc12_2" value="<%= d_sevm_sc12_2  %>" /></td>
				<td class=xl96>&nbsp;</td>
			</tr>
			<tr class=xl97 height=10 style='mso-height-source:userset;height:7.5pt'>
				<td height=10 class=xl97 style='height:7.5pt'></td>
