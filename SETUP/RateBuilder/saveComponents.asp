...
'end if
		...
		<% 	
			...
			d_samp_sc9_1	= toNumb(request.form("d_samp_sc9_1"))
			d_samp_sc9_2_3	= toNumb(request.form("d_samp_sc9_2_3"))
			
			d_samp_sc12_2	= toNumb(request.form("d_samp_sc12_2"))
			d_sevm_sc9_1	= toNumb(request.form("d_sevm_sc9_1"))
			d_sevm_sc9_2_3	= toNumb(request.form("d_sevm_sc9_2_3"))
			
			d_sevm_sc12_2	= toNumb(request.form("d_sevm_sc12_2"))
			d_sevm_r	= toNumb(request.form("d_sevm_r"))
			d_samp_r	= toNumb(request.form("d_samp_r"))
		...
		<% 
			if rbcid <> "" then
				...
				"','"&e_sbc_1&"','"&e_rpsp_r&"','"&e_rpsp_1&"','"&e_psls_r&"','"&e_psls_sc9_1&"','"&e_psls_sc12_2&"','"&e_psls_sc1_1&"','"&e_rdm_r&"','"&e_rdm_sc9_1&"','"&e_rdm_sc12_2&"','"&e_rdm_sc1_1&"','"&e_drs_r&"','"&e_drs_sc9_1&"','"&e_drs_sc12_2&"','"&e_drs_sc1_1&"','"&e_mfc_r&_
