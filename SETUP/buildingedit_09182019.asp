...
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxReport.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxReport','width=450,height=375, scrollbars=no')
	cWin.focus();
}
...
x                <% do until rst1.eof %>
    ...
    %>
            ...
            <td><!-- <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="open('/genergy2/eri_th/meterservices/MeterMaintenanceLetter.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no');" class="mgmtlink">Maintenance Letter</a><br/> -->
             ...
             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxReport(<%=pid%>);" class="mgmtlink">Building Tax Report(450Lex)</a><br>

             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxReportLoadFile(<%=pid%>);" class="mgmtlink">Building Tax Report Load File(450Lex)</a><br>
