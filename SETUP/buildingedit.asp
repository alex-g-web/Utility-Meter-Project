...
dim pid, bldg, edit,masterticketid,opentickets,criticalopentickets, totaltickets,bldgid, ticketcount,sqlstr, alertOn, managingcompany
...
if trim(bldg)<>"" then
	sqlstr="SELECT b.id as bldgid, b.offline as boffline, * FROM buildings b join portfolio p on b.portfolioid=p.id WHERE bldgnum='"&bldg&"'"
'	response.write sqlstr&"</br>"
	...
	if not rst1.EOF then
		...
		btzip = rst1("btzip")
		bldgid = rst1("bldgid")
		offline = rst1("boffline")
		ContactName = rst1("ContactName")
		ContactPhone = rst1("ContactPhone")
		managingcompany = rst1("managingcompany")
		alertOn = rst1("alertOn")
	end if
	rst1.close
end if
...
function openMaintainenceLetter(pidInt)
{
	if (pidInt == '108')
	cWin = window.open('/genergy2/eri_th/meterservices/MeterMaintenanceLetterPA.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no')
    else
	cWin = window.open('/genergy2/eri_th/meterservices/MeterMaintenanceLetter.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openMaintainenceLetterNew(pidInt)
{
	if (pidInt == '108')
	cWin = window.open('/genergy2/eri_th/meterservices/MeterMaintenanceLetterPA.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no')
    else
	cWin = window.open('/genergy2/eri_th/meterservices/MeterMaintenanceLetterNewVersion.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openMaintainenceLetterTEST(pidInt)
{
	if (pidInt == '108')
	cWin = window.open('/genergy2/eri_th/meterservices/MeterMaintenanceLetterPA.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no')
    else
	cWin = window.open('/genergy2/eri_th/meterservices/MeterMaintenanceLetterNewVersionTEST.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openBuildingTaxReport(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxPrepSheetSierra-RITA.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxPrepSheetSierra-RITA','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openBuildingTaxReportNoEsco(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxPrepSheetSierra-RITA-NoEsco.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxPrepSheetSierra-RITA-NoEsco','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openBuildingTaxReportCOMBINED(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxPrepSheetSierra-RITA-COMBINED.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxPrepSheetSierra-RITA-COMBINED','width=450,height=500, scrollbars=no')
	cWin.focus();
}

function openBuildingTaxPrepSheet(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxPrepSheet.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxPrepSheet','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openBuildingsPosted(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingsPosted.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingsPosted','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openBuildingTaxPrepSheetQuarterly(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxPrepSheetQuarterly.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxPrepSheetQuarterly','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openBuildingTaxPrepSheetSierra(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxPrepSheetSierra.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxPrepSheetSierra','width=450,height=375, scrollbars=no')
	cWin.focus();
}



function openUtilityBill(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/UtilityBillReport.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','UtilityBillReport','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openAutomatedRateEntry()
{
	cWin = window.open('/genergy2/eri_th/meterservices/AutomatedRateEntry.asp?','AutomatedRateEntry','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openMeterSetupCharges(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/MeterSetupCharges.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MeterSetupCharges','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openMeterSetupChargesBuilding(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/MeterSetupChargesBuilding.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MeterSetupChargesBuilding','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openBuildingTaxReportLoadFile(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/BuildingTaxReportLOADFILE.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','BuildingTaxReportLOADFILE','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openMeterCount(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/MeterCount.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MeterCount','width=450,height=375, scrollbars=no')
	cWin.focus();
}



function openMeterCountCharge(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/MeterCountCharge.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MeterCountCharge','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openMeterCountChargeBuilding(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/MeterCountChargeBuilding.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MeterCountChargeBuilding','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openTenantCharges(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/TenantCharges.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','TenantCharges','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openTenantChargesBuilding(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/TenantChargesBuilding.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','TenantChargesBuilding','width=450,height=375, scrollbars=no')
	cWin.focus();
}


function openMeterCountBuilding(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/MeterCountBuilding.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MeterCount','width=450,height=375, scrollbars=no')
	cWin.focus();
}

function openMeterListBuilding(pidInt)
{
	cWin = window.open('/genergy2/eri_th/meterservices/MeterListBuilding.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MeterList','width=450,height=375, scrollbars=no')
	cWin.focus();
}
...
function linkClicked(alertOn)
{
    if (alertOn == "True")
    {
        cwin = window.open("/genergy2/setup/alerts.asp?bldgNum=<%=bldg%>", "AlertSetup", "width=600,height=450, scrollbars=no");
    }
}

function buildingRateTypeView()
{
    cWin = window.open('buildingRateTypeView.asp?pid=<%=pid%>&bldg=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no')
	cWin.focus();
}
    ...
    <tr bgcolor="#eeeeee"> 
      ...
      <td><input type="Checkbox" name="submetered" value="1"></td>
          ...
          <tr> 
            ...
            <input type="checkbox" name="offline" <% if offline=true then %> checked <% end if %> /></td>
            ...
            <td width="30">&nbsp;</td>
            <td  align="right"><span class="standard">Building&nbsp;#(NO SPACES)</span></td>
            <td>
              <% if trim(bldg)="" then %>
		  ...
		  <tr>
			<h3><td width="50%"> Managed by: </td>
			<td width="50%"> <%= managingcompany %> </td></h3>
		  </tr>
          <tr bgcolor="#eeeeee"> 
...
x                <% do until rst1.eof %>
    ...
    loop %>
          ...
          <tr bgcolor="#eeeeee"> 
            ...
            <td>Turn Importer Alert on <input type="checkbox" name="alertOn" <% if (alertOn = true) then %> checked <% end if %> /></td>
            <% end if %>
          </tr>
          <tr bgcolor="#eeeeee"> 
    ...
    loop %>
        ...
        <table border=0 cellpadding="3" cellspacing="0" width="100%">
          ...
          <% end if %>
          <tr valign="top"> 
            <td><b <%if isBuildingOff(bldg) then%>class="grayout"<%end if%>>Building # <%=ucase(bldg)%> (<%=bldgname%>)</b></td>
    ...
    %>
            ...
            <tr valign="top" bgcolor="#eeeeee">
              <td>Status:</td>
              <td><%if offline=true then%>Offline<%else%>Online<%end if%></td>
            </tr>
			<tr>
			<td width="50%"><h3> Managed by: </h3></td>
			<td width="50%"><h1> <%= managingcompany %> </h1></td>
		  </tr>
          </table>
        </div>
        ...
        <table border="0" cellpadding="3" cellspacing="0">
          <tr valign="top"> 
            <td> 
			  ...
			  <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="javascript:buildingRateTypeView();" class="mgmtlink">Manage building level default rate type</a><br>
			</td>
            <td width="8">&nbsp;</td>
			<td>
			<%if not(isBuildingOff(bldg)) then%>
	...
	%>
      <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="open('gatewaysetup.asp?bldgnum=<%=bldg%>&select=','getawaysetup','width=600,height=450, scrollbars=auto');" class="mgmtlink">Gateway Setup</a><br>
    ...
    %>
            ...
            <td><!-- <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="open('/genergy2/eri_th/meterservices/MeterMaintenanceLetter.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no');" class="mgmtlink">Maintenance Letter</a><br/> -->
			 ...
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMaintainenceLetterNew(<%=pid%>);" class="mgmtlink">Maintenance Letter NEW</a><br>

             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMeterCount(<%=pid%>);" class="mgmtlink">Meter Count</a><br>

             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMeterCountBuilding(<%=pid%>);" class="mgmtlink">Meter Count For Building</a><br>
            ...
            <!--****--> 
            <% if (allowGroups("IT Services")) then %>
             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0" ><a href="#" onClick="linkClicked('<%=alertOn%>')" class="mgmtlink" <% if (NOT alertOn) then %> disabled="disabled" <% end if %> >Importer Alert Setup</a><br />
            <% end if %>
            </td>
            <td width="8">&nbsp;</td>
            <td><!-- <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="open('/genergy2/eri_th/meterservices/MeterMaintenanceLetter.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no');" class="mgmtlink">Maintenance Letter</a><br/> -->
             ...
             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxReport(<%=pid%>);" class="mgmtlink">Building Tax Report RITA</a><br>
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxReportNoEsco(<%=pid%>);" class="mgmtlink">Building Tax Report RITA No Esco</a><br>
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxReportCOMBINED(<%=pid%>);" class="mgmtlink">Building Tax Report RITA COMBINED</a><br>
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxPrepSheet(<%=pid%>);" class="mgmtlink">Building Tax Prep Sheet</a><br>
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxPrepSheetQuarterly(<%=pid%>);" class="mgmtlink">Building Tax Prep Sheet Quarterly</a><br>
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingTaxPrepSheetSierra(<%=pid%>);" class="mgmtlink">Building Tax Prep Sheet Sierra</a><br>

            </td>
            <td><!-- <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="open('/genergy2/eri_th/meterservices/MeterMaintenanceLetter.asp?pid=<%=pid%>&bldgNum=<%=bldg%>','MaintenanceLetter','width=450,height=375, scrollbars=no');" class="mgmtlink">Maintenance Letter</a><br/> -->
		
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMeterCountCharge(<%=pid%>);" class="mgmtlink">Meters Estimated Charged Count</a><br>

             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMeterCountChargeBuilding(<%=pid%>);" class="mgmtlink">Meters Estimated Charged For Building</a><br>
                
             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openTenantCharges(<%=pid%>);" class="mgmtlink">Tenant Charges</a><br>

             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openTenantChargesBuilding(<%=pid%>);" class="mgmtlink">Tenant Charges For Building</a><br>

             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMeterSetupCharges(<%=pid%>);" class="mgmtlink">Meter Setup Charges</a><br>

             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMeterSetupChargesBuilding(<%=pid%>);" class="mgmtlink">Meter Setup Charges For Building</a><br>

            </td>
            <td>
		
			 <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openUtilityBill(<%=pid%>);" class="mgmtlink">Building Utility Bill Report</a><br>
             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openBuildingsPosted(<%=pid%>);" class="mgmtlink">Buildings Posted</a><br>
            
             <img src="images/aro-rt.gif" align="absmiddle" hspace="2" border="0"><a href="#" onClick="openMeterListBuilding(<%=pid%>);" class="mgmtlink">Building Meter List</a><br>
...
if trim(bldg)<>"" then
	...
	sqlstr="SELECT count(*) as count FROM tblleases WHERE bldgnum='"&bldg&"' and LeaseExpired=0"
...
%>
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="0">
  <tr bgcolor="#eeeeee">
    <td style="border-top:1px solid #ffffff;border-bottom:1px solid #999999;"><span class="standard"><br><b>Accounts  :  <%=accounts%></b></span></td>
  ...
  <% if not rst1.EOF then %>
    ...
    <tr bgcolor="#dddddd">
      ...
      <td width="20%"><span class="standard"><b>Billing ID</b></span></td>
      <td width="20%"><span class="standard"><b>Account Number</b></span></td>
      <td width="10%"><span class="standard"><b>Floor</b></span></td>
      <td width="10%"><span class="standard"><b>sqft</b></span></td>
    </tr>
    </table>
    ...
    <%do until rst1.EOF
    	...
    	<tr bgcolor="#ffffff" onMouseOver="this.style.backgroundColor = 'lightgreen'" onMouseOut="this.style.backgroundColor = 'white'" onClick="tenantEdit(<%=rst1("billingid")%>);">
      		<td width="40%"><%=fonttag%><span class="standard"><%=rst1("billingname")%><%if rst1("tickets") <> "" then %> <font color="#FF0000">[<%=rst1("tickets")%> critical ticket(s)]</font><%end if%></span><%=unfonttag%><% if rst1("paperless") then %><img src="images/paperless.png" width="12" height="12" border="0"> <% end if %></td>
      		<td width="20%"><%=fonttag%><span class="standard"><%=rst1("billingid")%></span><%=unfonttag%></td>
      		<td width="20%"><%=fonttag%><span class="standard"><%=rst1("tenantnum")%></span><%=unfonttag%></td>
      		<td width="10%"><%=fonttag%><span class="standard"><%=rst1("Flr")%></span><%=unfonttag%></td>
      		<td width="10%"><%=fonttag%><span class="standard"><%=rst1("sqft")%></span><%=unfonttag%></td>
    	</tr>
    	<%
		fonttag=""
		unfonttag=""
