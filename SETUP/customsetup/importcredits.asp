...
<html>
<head>
<title>Import Credits/Adjustments</title>
</head>
<%
...
%>
<body>
	<form action="asp_csv_import2.asp?bldg=<%=bldg%>&byear=<%=byear%>&bperiod=<%=bperiod%>&utilid=<%=utilid%>" method="post" enctype="multipart/form-data" name="frmMain">
	Upload 
